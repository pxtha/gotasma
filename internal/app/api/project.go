...
func newProjectService(policy project.PolicyService, updateUser project.UserService, holiday project.HolidayService) (*project.Service, error) {
	...
	return project.New(repo, policy, updateUser, elastic, holiday), nil
}
